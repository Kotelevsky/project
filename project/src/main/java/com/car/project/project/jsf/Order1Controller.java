...
import com.car.project.project.session.Order1Facade;
...
public class Order1Controller implements Serializable {
    ...
    @EJB
    private com.car.project.project.session.Order1Facade ejbFacade;
    ...
    public static class Order1ControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Order1) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Order1Controller.class.getName());
            }
        }
    }
}
