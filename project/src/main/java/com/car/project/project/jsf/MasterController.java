...
import com.car.project.project.session.MasterFacade;
...
public class MasterController implements Serializable {
    ...
    @EJB
    private com.car.project.project.session.MasterFacade ejbFacade;
    ...
    private MasterFacade getFacade() {
        return ejbFacade;
    }
    ...
    public static class MasterControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Master) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + MasterController.class.getName());
            }
        }
    }
}
