...
import com.car.project.project.session.ManagerFacade;
...
public class ManagerController implements Serializable {
    ...
    @EJB
    private com.car.project.project.session.ManagerFacade ejbFacade;
    ...
    public static class ManagerControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Manager) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + ManagerController.class.getName());
            }
        }
    }
}
