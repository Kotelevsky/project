...
import com.car.project.project.session.WorkFacade;
...
public class WorkController implements Serializable {
    ...
    @EJB
    private com.car.project.project.session.WorkFacade ejbFacade;
    ...
    public Work getSelected() {
        if (current == null) {
            current = new Work();
            current.setWorkPK(new com.car.project.project.entity.WorkPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public static class WorkControllerConverter implements Converter {
        ...
        com.car.project.project.entity.WorkPK getKey(String value) {
            com.car.project.project.entity.WorkPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.car.project.project.entity.WorkPK();
            key.setId(Integer.parseInt(values[0]));
            key.setSpareid(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(com.car.project.project.entity.WorkPK value) {
            StringBuffer sb = new StringBuffer();
            sb.append(value.getId());
            sb.append(SEPARATOR);
            sb.append(value.getSpareid());
            return sb.toString();
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Work) {
                Work o = (Work) object;
                return getStringKey(o.getWorkPK());
            } else {
