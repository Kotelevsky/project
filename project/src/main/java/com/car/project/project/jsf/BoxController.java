...
import com.car.project.project.session.BoxFacade;
...
@ManagedBean(name = "boxController")
@SessionScoped
public class BoxController implements Serializable {
    ...
    @EJB
    private com.car.project.project.session.BoxFacade ejbFacade;
    ...
    public static class BoxControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Box) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + BoxController.class.getName());
            }
        }
    }
}
