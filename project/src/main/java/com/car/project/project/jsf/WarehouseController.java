...
public class WarehouseController implements Serializable {
    ...
    @EJB
    private com.car.project.project.session.WarehouseFacade ejbFacade;
    ...
    public static class WarehouseControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Warehouse) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + WarehouseController.class.getName());
            }
        }
    }
}
